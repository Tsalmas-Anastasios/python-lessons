...
# ----------
#
#   - Μάθαμε πώς να χρησιμοποιούμε την ώρα του συστήματος στα προγράμματά μας
#   - Μάθαμε πώς να αναζητούμε και να βάζουμε δικούς μας ήχους και εικονίδια
#     στο πρόγραμμά μας.
#   - Μάθαμε πώς να δομούμε ένα πρόγραμμα!
